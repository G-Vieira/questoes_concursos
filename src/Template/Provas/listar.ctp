...
<div class="provas index large-10 medium-8 columns content">
  <h3><?= __('Provas') ?></h3>
  <form method="POST" accept-charset="utf-8" action="/questoes_concursos/provas/listar/">
    <input type="text" placeholder="Pesquisar provas por uma pergunta" name="pesquisa" class="inpt_pesquisa">
    <button type="submit" class="btn_pesquisa">Pesquisar</button>
  </form>
  <br>
